...
if __name__ == "__main__":
    ...
    install_command = f'pyinstaller.exe -F --hidden-import=matplotlib.pyplot --hidden-import=sqlite3 --hidden-import=pandas --hidden-import=tqdm --hidden-import=smtplib --hidden-import=email.mime.image --hidden-import=email.mime.text --hidden-import=email.mime.multipart --hidden-import=email.mime.application --icon={icon_name} {file_to_compile}'
